            ...
            <div class="row">
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    <div class="block1 wrap-pic-w">
                        ...
                        <a href="#mujer" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                ...
                <div class="dis-none panel-filter w-full p-t-10">
                    <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                        ...
                        <div class="filter-col4 p-r-15 p-b-27">
                            ...
                            <ul>
                                <li class="p-b-6">
                                    <span class="fs-15 lh-12 m-r-6" style="color: #41e85a;">
                                        <i class="zmdi zmdi-circle"></i>
                                    </span>
                                    <a href="#" class="filter-link stext-106 trans-04 filter-link-active"">
                                        Todo el año
                                ...
                                <li class="p-b-6">
                                    <span class="fs-15 lh-12 m-r-6" style="color: #e6b626;">
                                        <i class="zmdi zmdi-circle"></i>
                                    </span>
                                    <a href="#" class="filter-link stext-106 trans-04">
                                        Primavera / Verano
                                ...
                                <li class="p-b-6">
                                    <span class="fs-15 lh-12 m-r-6" style="color: #2e5ab8;">
                                        <i class="zmdi zmdi-circle"></i>
                                    </span>
                                    <a href="#" class="filter-link stext-106 trans-04">
                                        Otoño / Invierno
